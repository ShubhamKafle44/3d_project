...
class PanelsMixin:
    ...
    # ── Selector group (three dropdowns) ─────────────────────────────────────
    ...
    def _build_position_group(self) -> QGroupBox:
        ...
        for attr, axis, lo, hi, init in [
            ...
            # FIX: capture 'slider' as default arg 'sl' to avoid closure-over-loop-var bug
    ...
    def _build_center_panel(self) -> QWidget:
        ...
        # ── Optimisation settings row (NEW — needed by OptimisationMixin) ─────
        opt_row = QHBoxLayout()
        ...
        # ── Optimisation status labels (NEW — needed by OptimisationMixin) ────
